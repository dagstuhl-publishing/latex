...
class DagstuhlReports_v2018b implements StyleDescription
{
    public static function getMetadataItems()
    {
        return [
            ...
            [
                'name' => 'authors',
                'type' => MetadataItem::TYPE_CALCULATED,
                'latexIdentifier' => 'none',
                'properties' => [ 'name', 'affiliation', 'email', 'orcid', 'funding' ],
                'mappings' => [
                    MetadataReader::FORMAT_UTF8 => [
                        'name' => [ MetadataMappings::class.'::calculateReportAuthorV1' ],
                        'affiliation' => [ MetadataMappings::class.'::calculateReportAffiliationV1' ],
                        'email' => [ MetadataMappings::class.'::calculateReportEmailV1' ],
                        'orcid' => [ MetadataMappings::class.'::calculateReportEmptyAuthorArgV1' ],
                        'funding' => [ MetadataMappings::class.'::calculateReportEmptyAuthorArgV1' ]
                    ]
                ],
                'groups' => [
                    MetadataItem::GROUP_MANDATORY, MetadataItem::GROUP_MULTI
